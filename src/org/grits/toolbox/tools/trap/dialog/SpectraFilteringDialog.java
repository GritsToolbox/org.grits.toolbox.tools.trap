...
public class SpectraFilteringDialog extends TitleAreaDialog {
	...
	private SpectrumFilter		spectrumFilter		= new SpectrumFilter();
	...
	private void createSpectraFilter(Composite container) {
		...
		GridData browseData = new GridData(SWT.FILL, SWT.TOP, true, true, 1, 1);
		browseData.horizontalSpan = 4;
		...
		mzvalueGrid.horizontalSpan = 1;
		
		mzvalueText = new Text(container, SWT.MULTI | SWT.V_SCROLL | SWT.BORDER);
		...
		accuracyValueText = new Text(container, SWT.MULTI | SWT.V_SCROLL | SWT.BORDER);
		...
		cutOfValueText = new Text(container, SWT.MULTI | SWT.V_SCROLL | SWT.BORDER);
	...
	protected void okPressed() {
		...
		spectrumFilter = new SpectrumFilter();
	...
	public SpectrumFilter getFiler() {
