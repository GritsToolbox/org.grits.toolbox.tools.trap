package org.grits.toolbox.tools.trap.MzXMLWriter;

import java.io.BufferedWriter;
import java.io.FileWriter;
import java.io.IOException;

import org.grits.toolbox.tools.trap.util.Base64SpectraUtil;
...
public class MzXMLWriter {
	...
	public void writeHeader() throws IOException {
		...
		String content = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\n"
		        ...
		        + "\n" + "<msRun scanCount=\"22\" startTime=\"PT2175.88S\" endTime=\"PT2183.31S\">" + "\n";
	...
	public void writeScan(Scan scan) throws IOException {
		...
		XMLOutputter t_outputter = new XMLOutputter(Format.getCompactFormat());
